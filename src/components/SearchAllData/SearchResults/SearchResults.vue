...
export default {
  ...
  methods: {
    ...
    fetchRecordsV1: function() {
      ...
      const url = `https://api.pennsieve.io/models/datasets/N:dataset:e2de8e35-7780-40ec-86ef-058adf164bbc/concepts/${this.$route.params.conceptId}/instances?api_key=`
