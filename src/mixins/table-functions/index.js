...
import { compose, head, defaultTo, propOr, pathOr, sort, includes, length } from 'ramda'
  ...
  methods: {
    ...
    */
    ...
    renderHeader: function(h, { column, store}) {
      ...
      const nonSortable = includes(property, nonSortableColumns)
      let children = label
